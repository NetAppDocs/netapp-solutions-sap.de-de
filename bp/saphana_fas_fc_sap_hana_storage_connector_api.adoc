...
link:saphana_fas_fc_storage_controller_setup.html["Früher: Einrichtung von Storage Controller."]
...
link:saphana_fas_fc_host_setup.html["Weiter: Host-Einrichtung."]
