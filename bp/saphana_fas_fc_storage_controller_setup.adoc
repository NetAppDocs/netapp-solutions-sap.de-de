...
link:saphana_fas_fc_time_synchronization.html["Zurück: Zeitsynchronisierung."]
...
Bei SAP HANA wird NetApp Volume Encryption (NVE) unterstützt.
...
link:saphana_fas_fc_sap_hana_storage_connector_api.html["Weiter: SAP HANA Storage Connector API"]
