...
Detaillierte Informationen zur SAP HANA-Backup- und -Wiederherstellungslösung finden Sie unter link:../backup/hana-sc-generic-scope.html["Technischer Bericht: SAP HANA Backup and Recovery with SnapCenter"^]Die
