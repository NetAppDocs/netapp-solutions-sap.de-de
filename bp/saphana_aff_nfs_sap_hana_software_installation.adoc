...
link:saphana_aff_nfs_sap_hana_data_volume_size.html["Früher: Größe des SAP HANA Datenvolumens."]
...
link:saphana_aff_nfs_adding_additional_data_volume_partitions.html["Weiter: Zusätzliche Daten-Volume-Partitionen."]
