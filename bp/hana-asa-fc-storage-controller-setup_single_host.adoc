...
Die folgende Tabelle zeigt die LUN-Konfiguration eines Single-Host-SAP HANA-Systems.

|===
| Zweck | LUNs | LVM-Logisches Volume 


| Daten | FC5_data_mnt00001_1 FC5_data_mnt00001_2 | FC5_data_mnt00001-vol 


| Protokoll | FC5_log_mnt00001_1 FC5_log_mnt00001_2 | FC5_log_mnt00001-vol 


| Gemeinsam | FC5_shared | k. A. 
|===

NOTE: Mit der beschriebenen Konfiguration befindet sich das `/usr/sap/SID1` Verzeichnis, in dem das Standard-Home-Verzeichnis des Benutzers SID1adm gespeichert ist, auf der lokalen Festplatte. In einer Notfallwiederherstellungsumgebung mit festplattenbasierter Replikation empfiehlt NetApp, eine zusätzliche LUN für das `/usr/sap/SID1` Verzeichnis zu erstellen, sodass sich alle Dateisysteme auf dem zentralen Speicher befinden.


NOTE: Wenn der SAP Local Secure Store Service (LSS) verwendet wird, befindet sich das  `/lss/shared/SID` Verzeichnis, das Standardinstallationsverzeichnis von LSS, auf der lokalen Festplatte. In einer Disaster-Recovery-Umgebung mit festplattenbasierter Replikation empfiehlt NetApp, eine zusätzliche LUN für das  `/lss/shared/SID` Verzeichnis zu erstellen, sodass sich alle Dateisysteme auf dem zentralen Speicher befinden.
