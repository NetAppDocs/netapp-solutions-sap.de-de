...
link:saphana_aff_nfs_sap_hana_software_installation.html["Früher: Installation der SAP HANA Software."]
...
....
image:saphana_aff_nfs_image18.jpg["Fehler: Fehlendes Grafikbild"]

link:saphana_aff_nfs_where_to_find_additional_information.html["Weiter: Wo finden Sie zusätzliche Informationen."]
