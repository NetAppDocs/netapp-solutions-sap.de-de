...
image::saphana_aff_nfs_image10.png[Saphana AFF nfs image10]
...
image::saphana_aff_nfs_image11.png[Saphana AFF nfs image11]
...
image::saphana_aff_nfs_image12.png[Saphana AFF nfs image12]
