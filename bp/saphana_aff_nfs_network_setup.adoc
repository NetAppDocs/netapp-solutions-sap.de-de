...
link:saphana_aff_nfs_infrastructure_setup_and_configuration_overview.html["Früher: Einrichtung und Konfiguration der Infrastruktur."]
...
link:saphana_aff_nfs_time_synchronization.html["Weiter: Zeitsynchronisierung."]
