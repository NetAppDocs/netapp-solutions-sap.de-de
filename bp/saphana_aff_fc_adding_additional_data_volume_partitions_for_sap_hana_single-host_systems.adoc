...
link:saphana_aff_fc_sap_hana_software_installation.html["Früher: Installation der SAP HANA Software."]
...
link:saphana_aff_fc_where_to_find_additional_information.html["Weiter: Wo finden Sie zusätzliche Informationen."]
