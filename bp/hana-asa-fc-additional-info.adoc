...
* link:../backup/hana-dr-sr-pdf-link.html["Technischer Bericht: SAP HANA Disaster Recovery with Storage Replication"^]
* link:../backup/hana-sc-vmware-smas-scope.html["SAP HANA Datensicherung und Hochverfügbarkeit mit SnapCenter, SnapMirror Active Sync und VMware Metro Storage Cluster"^]
