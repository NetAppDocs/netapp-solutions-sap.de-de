...
link:saphana_aff_fc_host_setup.html["Früher: Host-Einrichtung."]
...
....
link:saphana_aff_fc_sap_hana_software_installation.html["Weiter: Installation der SAP HANA Software."]
