...
link:saphana_fas_fc_adding_additional_data_volume_partitions_for_sap_hana_single-host_systems.html["Früher: Zusätzliche Daten-Volume-Partitionen für SAP HANA Single-Host-Systeme hinzufügen."]
...
link:saphana_fas_fc_update_history.html["Weiter: Aktualisierungsverlauf."]
