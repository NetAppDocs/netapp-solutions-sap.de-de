...
link:saphana_fas_fc_infrastructure_setup_and_configuration_overview.html["Früher: Einrichtung und Konfiguration der Infrastruktur."]
...
link:saphana_fas_fc_time_synchronization.html["Weiter: Zeitsynchronisierung."]
