...
link:saphana_aff_fc_adding_additional_data_volume_partitions_for_sap_hana_single-host_systems.html["Früher: Zusätzliche Daten-Volume-Partitionen für SAP HANA Single-Host-Systeme hinzufügen."]
...
* TR-4667: Automatisierung von SAP Systemkopien mithilfe des SnapCenter 4.0 SAP HANA Plugin
+
...
* NetApp AFF Storage-Systemressourcen
+
...
link:saphana_aff_fc_update_history.html["Weiter: Aktualisierungsverlauf."]
