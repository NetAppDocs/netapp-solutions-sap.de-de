...
link:saphana_aff_nfs_architecture.html["Früher: Architektur."]
...
Die Mindestanzahl von 12 NVMe-SSDs für das erste Shelf unterstützt bis zu 16 SAP HANA-Hosts. Ein vollständig bestücktes Shelf (24 SSDs) unterstützt bis zu 48 SAP HANA-Hosts. Das gleiche gilt für die internen Festplatten eines AFF A800 Systems.
...
link:saphana_aff_nfs_infrastructure_setup_and_configuration_overview.html["Als Nächstes: Einrichtung und Konfiguration der Infrastruktur."]
