...
Eine NVMe-SSD (Daten) unterstützt bis zu 5 SAP HANA-Hosts. Die SSDs und SAP HANA-Hosts müssen auf beide Storage-Controller verteilt sein.
...
image:saphana_aff_nfs_image9.jpg["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
