...
link:saphana_aff_nfs_storage_controller_setup.html["Früher: Einrichtung von Storage Controller."]
...
| rw, bg, Hard, timeso=600, noatim | Vers=3, Nolock | Vers=4,minorversion=1,Sperre | Rsize=1048576,wsize=262144 | Rsize=65536,wsize=65536 
|===
...
link:saphana_aff_nfs_sap_hana_installation_preparations_for_nfsv4.html["Weiter: Vorbereitungen für die Installation von SAP HANA für NFSv4"]
