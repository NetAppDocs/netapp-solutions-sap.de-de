...
Die Mindestanzahl von 12 NVMe-SSDs für das erste Shelf unterstützt bis zu 16 SAP HANA-Hosts. Ein vollständig bestücktes Shelf unterstützt bis zu 48 SAP HANA-Hosts.
