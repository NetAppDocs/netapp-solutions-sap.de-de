...
link:saphana_aff_fc_architecture.html["Früher: Architektur."]
...
Die Mindestanzahl von 12 NVMe-SSDs für das erste Shelf unterstützt bis zu 18 SAP HANA-Hosts. Ein vollständig bestücktes Shelf unterstützt bis zu 48 SAP HANA-Hosts.
...
image:saphana_aff_fc_image8.jpg["Fehler: Fehlendes Grafikbild"]

link:saphana_aff_fc_infrastructure_setup_and_configuration_overview.html["Als Nächstes: Einrichtung und Konfiguration der Infrastruktur."]
