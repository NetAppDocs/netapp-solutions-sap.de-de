...
image::saphana-fas-nfs_image10.png[Saphana FAS nfs image10]
...
image::saphana-fas-nfs_image11.png[Saphana FAS nfs image11]
...
image::saphana-fas-nfs_image12.png[Saphana FAS nfs image12]
