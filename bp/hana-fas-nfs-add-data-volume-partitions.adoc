...
Zusätzlich zu den im Abschnitt beschriebenen Aufgaben link:hana-fas-nfs-host-setup.html["„Host-Einrichtung“,"]müssen Sie die zusätzlichen Mount-Punkte und fstab-Einträge für die neuen zusätzlichen Daten-Volumes erstellen und die neuen Volumes mounten.
...
....
image:saphana-fas-nfs_image19.png["Die Abbildung zeigt den Input/Output-Dialog oder die Darstellung des schriftlichen Inhalts"]
