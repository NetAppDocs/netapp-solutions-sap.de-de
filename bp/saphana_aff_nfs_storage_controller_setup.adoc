...
. Erstellen einer Storage Virtual Machine (SVM) wie unter „ configuration.“
. Erstellen Sie LIFs wie in „ “ beschrieben. configuration.“
. Erstellen von Volumes in den Aggregaten wie unter „“ beschrieben configuration for SAP HANA single host systems" Und " configuration for SAP HANA multiple host systems.“
. Legen Sie die erforderlichen Volume-Optionen fest, wie unter „ “ beschrieben. options.“
. Legen Sie die erforderlichen Optionen für NFSv3 fest, wie in „ “ beschrieben. configuration for NFSv3„ Oder für NFSv4 wie in „ “ beschrieben configuration for NFSv4.“
. Mounten Sie die Volumes in Namespace und legen Sie die Richtlinien für den Export wie in „ “ beschrieben fest. volumes to namespace and set export policies.“
