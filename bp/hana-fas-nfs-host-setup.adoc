...
[[create-subdirectories-in-hanashared-volume]]
== Unterverzeichnisse in /hana/Shared-Volume erstellen


NOTE: Die Beispiele zeigen eine SAP HANA Datenbank mit SID=NF2 unter Verwendung von LSS.

Um die erforderlichen Unterverzeichnisse zu erstellen, führen Sie eine der folgenden Aktionen durch:

* Für ein Einzel-Host-System binden Sie das  `/hana/shared` Volume ein und erstellen Sie die  `shared`,  `lss-shared` und  `usr-sap` Unterverzeichnisse.
...
sapcc-hana-tst-06:/mnt/tmp # mkdir lss-shared
sapcc-hana-tst-06:/mnt/tmp # mkdir usr-sap
sapcc-hana-tst-06:mnt/tmp # cd ..
sapcc-hana-tst-06:/mnt # umount /mnt/tmp
....
* Für ein System mit mehreren Hosts binden Sie das  `/hana/shared` Volume ein und erstellen Sie die  `shared`,  `lss-shared` und die  `usr-sap` Unterverzeichnisse für jeden Host.
+
...
sapcc-hana-tst-06:/ # mkdir -p /lss/shared/
sapcc-hana-tst-06:/ # mkdir -p /usr/sap/NF2
sapcc-hana-tst-06:/ # chmod –R 777 /hana/log/NF2
sapcc-hana-tst-06:/ # chmod –R 777 /hana/data/NF2
sapcc-hana-tst-06:/ # chmod -R 777 /hana/shared
sapcc-hana-tst-06:/ # chmod -R 777 /lss/shared
...
sapcc-hana-tst-07:/ # mkdir -p /lss/shared/
sapcc-hana-tst-07:~ # mkdir -p /usr/sap/NF2
sapcc-hana-tst-07:~ # chmod -R 777 /hana/log/NF2
sapcc-hana-tst-07:~ # chmod -R 777 /hana/data/NF2
sapcc-hana-tst-07:~ # chmod -R 777 /hana/shared
sapcc-hana-tst-07:/ # chmod -R 777 /lss/shared
...
sapcc-hana-tst-08:/ # mkdir -p /lss/shared/
sapcc-hana-tst-08:~ # mkdir -p /usr/sap/NF2
sapcc-hana-tst-08:~ # chmod -R 777 /hana/log/NF2
sapcc-hana-tst-08:~ # chmod -R 777 /hana/data/NF2
sapcc-hana-tst-08:~ # chmod -R 777 /hana/shared
sapcc-hana-tst-08:/ # chmod -R 777 /lss/shared
...
| /lss/shared | NFSv3 oder NFSv4 | NFSv3 oder NFSv4 
...
<storage-vif-data01>:/NF2_shared/lss-shared /lss/shared nfs rw,nfsvers=3,hard,timeo=600,nconnect=4,rsize=1048576,wsize=262144,bg,noatime,nolock 0 0
....
. Führen Sie  `mount -a` aus, um die Dateisysteme auf allen Hosts einzubinden.


Das nächste Beispiel zeigt eine SAP HANA Datenbank mit SID=NF2, die NFSv4.1 für Daten- und Protokolldateisysteme und NFSv3 für die  `/hana/shared`, `/lss/shared`, und  `/usr/sap/NF2` Dateisysteme verwendet. Eine NFS-Übertragungsgröße von 1 MB für Lesevorgänge und 256 KB für Schreibvorgänge wird verwendet.
...
<storage-vif-data02>:/NF2_shared/lss-shared /lss/shared nfs rw,nfsvers=3,hard,timeo=600,nconnect=4,rsize=1048576,wsize=262144,bg,noatime,nolock 0 0
....
. Führen Sie  `mount -a` aus, um die Dateisysteme auf allen Hosts einzubinden.
