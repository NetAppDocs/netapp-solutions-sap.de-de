...
NOTE: NetApp ASA -Systeme unterstützen NFS nicht als Protokoll.  NetApp empfiehlt den Einsatz eines zusätzlichen AFF oder FAS -Systems für die `/hana/shared` Dateisystem.
