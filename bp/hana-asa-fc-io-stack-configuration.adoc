...
keywords: io, io-stack, configuration, database 
summary: Ab SAP HANA 1.0 SPS10 führte SAP Parameter ein, um das IO-Verhalten anzupassen und die Datenbank für das verwendete Datei- und Speichersystem zu optimieren. 
---
...
[[io-stack-configuration-for-sap-hana]]
== I/O-Stack-Konfiguration für SAP HANA
