...
link:saphana_fas_fc_introduction.html["Früher: SAP HANA on FAS Systems with FCP Configuration Guide."]
...
link:saphana_fas_fc_storage_sizing.html["Als Nächstes: Storage-Sizing."]
