...
image:saphana_aff_fc_image5.jpg["Fehler: Fehlendes Grafikbild"]
...
Detaillierte Informationen zur Backup- und Recovery-Lösung für SAP HANA finden Sie unter https://www.netapp.com/us/media/tr-4614.pdf["TR-4614: SAP HANA Backup and Recovery with SnapCenter"^].
...
image:saphana_aff_fc_image6.png["Fehler: Fehlendes Grafikbild"]
...
image:saphana_aff_fc_image7.png["Fehler: Fehlendes Grafikbild"]

link:saphana_aff_fc_storage_sizing.html["Als Nächstes: Storage-Sizing."]
