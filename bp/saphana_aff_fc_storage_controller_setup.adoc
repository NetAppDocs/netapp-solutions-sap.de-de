...
link:saphana_aff_fc_time_synchronization.html["Zurück: Zeitsynchronisierung."]
...
. Überprüfen Sie die richtige Festplatten-Shelf-Konfiguration, wie unter „ “ beschrieben. shelf connection.“
. Erstellen und Konfigurieren der erforderlichen Aggregate, wie unter „ “ beschrieben configuration.“
. Erstellen einer Storage Virtual Machine (SVM), wie unter „ virtual machine configuration.“
. Logische Schnittstellen (LIFs) erstellen, wie in „ “ beschrieben interface configuration.“
. Erstellen Sie einen Portsatz, wie unter „ “ beschrieben. port sets.“
. Erstellen von Initiatorgruppen, Volumes und LUNs in den Aggregaten, wie unter Erstellen von „ “ beschrieben and volumes and mapping LUNs to initiator groups.“
...
link:saphana_aff_fc_sap_hana_storage_connector_api.html["Weiter: SAP HANA Storage Connector API"]
