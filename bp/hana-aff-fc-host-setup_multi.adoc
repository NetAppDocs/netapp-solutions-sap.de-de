...
Um die erforderlichen Mount-Point-Verzeichnisse zu erstellen, legen Sie Berechtigungen fest und erstellen Sie Mount-Points auf allen Worker- und Standby-Hosts.
