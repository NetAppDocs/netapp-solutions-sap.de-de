...
image:saphana_aff_nfs_image2a.png["Acht SAP HANA-Hosts, die an ein Storage-HA-Paar angeschlossen sind"]
...
image:saphana_aff_nfs_image3a.png["Zusätzliche SAP HANA-Hosts zu einem vorhandenen Storage Controller HA-Paar"]
...
image:saphana_aff_nfs_image4a.png["Zusätzliches HA-Paar hinzugefügt"]
