...
image::saphana_aff_nfs_image2.png[Saphana AFF nfs image2]

Die folgende Abbildung zeigt ein Beispiel für die Nutzung von VMware vSphere als Virtualisierungsebene.

image::saphana_aff_nfs_image3.jpg[Saphana AFF, nfs-Bild3]
...
image::saphana_aff_nfs_image4.png[Saphana AFF nfs image4]
...
image::saphana_aff_nfs_image5.png[Saphana AFF nfs image5]
...
image::saphana_aff_nfs_image6.jpg[Saphana AFF nfs image6]
...
image::saphana_aff_nfs_image7.png[Saphana AFF nfs image7]
...
image::saphana_aff_nfs_image8.png[Saphana AFF nfs image8]
