...
summary: Die neuen Volumes können nun auf der Grundlage der zuvor erstellten /etc/fstab-Datei auf dem Zielhost eingebunden werden. 
---
...
link:saphana-dr-anf_create_new_volumes_based_on_snapshot_backups_at_the_disaster_recovery_site.html["Früher: Erstellen Sie neue Volumes auf Basis von Snapshot-Backups am Disaster-Recovery-Standort."]
...
....
link:saphana-dr-anf_hana_database_recovery.html["In der nächsten Generation: HANA Datenbank-Recovery"]
