...
link:saphana-br-scs-snapcenter-resource-specific-configuration-for-non-data-volume-backups.html["Früher: Ressourcenspezifische SnapCenter Konfiguration für Backups außerhalb von Datenvolumen."]
...
link:saphana-br-scs-block-integrity-check.html["Als Nächstes: Block-Integritätsprüfung"]
