...
Detaillierte Informationen zu den Workflows für die Systemaktualisierung sind verfügbar unter: link:../lifecycle/sc-copy-clone-introduction.html["TR-4667: Automatisierung von SAP HANA Systemkopie und Klonvorgängen mit SnapCenter"]
