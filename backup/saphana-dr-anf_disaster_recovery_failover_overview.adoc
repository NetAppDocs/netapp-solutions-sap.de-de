...
link:saphana-dr-anf_hana_database_recovery.html["Früher: HANA Datenbank-Recovery"]
...
link:saphana-dr-anf_prepare_the_target_host_01.html["Als Nächstes: Bereiten Sie den Zielhost vor."]
