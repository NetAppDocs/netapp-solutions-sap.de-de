...
link:saphana-dr-anf_disaster_recovery_testing_overview.html["Früher: Disaster-Recovery-Tests."]
...
....
link:saphana-dr-anf_create_new_volumes_based_on_snapshot_backups_at_the_disaster_recovery_site.html["Dann: Erstellen Sie neue Volumes auf Basis von Snapshot-Backups am Disaster-Recovery-Standort."]
