...
....
Weitere Informationen zu den Bereitstellungsoptionen für SAP HANA Plug-in und zur Konfiguration des Benutzerspeichers finden Sie in link:hana-sc-generic-scope.html["Technischer Bericht: SAP HANA Backup and Recovery with SnapCenter"^].
