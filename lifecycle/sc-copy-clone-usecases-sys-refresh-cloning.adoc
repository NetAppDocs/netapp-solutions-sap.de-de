...
Logische Datenbeschädigung kann durch Softwarefehler, menschliche Fehler oder Sabotage verursacht werden. Leider kann logische Datenbeschädigung häufig nicht mit Standardlösungen für Hochverfügbarkeit und Notfallwiederherstellung behoben werden. Daher können je nach Ebene, Anwendung, Dateisystem oder Speicher, in dem die logische Datenbeschädigung aufgetreten ist, die Anforderungen an maximale Ausfallzeit und Datenverlust manchmal nicht erfüllt werden.
...
https://www.netapp.com/pdf.html?item=/media/8584-tr4646pdf.pdf["Technischer Bericht: SAP HANA Disaster Recovery with Storage Replication"]

link:../backup/hana-dr-anf-data-protection-overview.html["Disaster Recovery für SAP HANA mit Azure NetApp Files"]
