...
* link:../bp/hana-aff-fc-introduction.html["SAP HANA auf NetApp All Flash FAS Systemen mit Fibre Channel Protocol"]
* link:../bp/hana-aff-nfs-introduction.html["SAP HANA auf NetApp All Flash FAS-Systemen mit NFS"]
* link:../backup/fsxn-overview.html["SAP HANA auf Amazon FSX für NetApp ONTAP – Backup und Recovery mit SnapCenter"]
* link:lama-ansible-introduction.html["NetApp Integration des SAP Landscape Managements mit Ansible"]
* link:libelle-sc-overview.html["Automatisierung von SAP-Systemkopiervorgängen mit Libelle SystemCopy (netapp.com)"]
...
| Version 4.1 | Februar 2026 | Erforderliche Schritte für die HANA-Verschlüsselung und den SAP local secure store LSS hinzugefügt 
|===